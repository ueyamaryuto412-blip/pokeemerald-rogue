...
static const u8 sText_Stats_MoveLevel[] = _("{JPN}レベル");
...
static const u8 sText_Stats_CatchRate[] = _("{JPN}つかまえ{0x5B} ");
static const u8 sText_Stats_CatchRate_Legend[] = _("{JPN}でんせつ");
static const u8 sText_Stats_CatchRate_VeryHard[] = _("{JPN}とても きびしい");
static const u8 sText_Stats_CatchRate_Difficult[] = _("{JPN}むずかしい");
static const u8 sText_Stats_CatchRate_Medium[] = _("{JPN}ふつう");
static const u8 sText_Stats_CatchRate_Relaxed[] = _("{JPN}ゆるやか");
static const u8 sText_Stats_CatchRate_Easy[] = _("{JPN}やさしい");
static const u8 sText_Stats_ExpYield[] = _("{JPN}けいけんち ");
static const u8 sText_Stats_EggCycles[] = _("{JPN}かえる ほすう");
...
static const u8 sText_Stats_Growthrate[] = _("{JPN}せいちょう ");
static const u8 sText_Stats_Friendship[] = _("{JPN}なつきど");
...
static const u8 sText_Stats_MEDIUM_FAST[] = _("{JPN}やや はやい");
static const u8 sText_Stats_ERRATIC[] = _("{JPN}ふきそく");
static const u8 sText_Stats_FLUCTUATING[] = _("{JPN}へんどう");
static const u8 sText_Stats_MEDIUM_SLOW[] = _("{JPN}やや おそい");
static const u8 sText_Stats_FAST[] = _("{JPN}はやい");
static const u8 sText_Stats_SLOW[] = _("{JPN}おそい");
static const u8 sText_Stats_ContestHeart[] = _("{JPN}H");
static const u8 sText_Stats_Minus[] = _("-");
static const u8 sText_Stats_eggGroup[] = _("{JPN}タマゴG1");
...
static const u8 sText_Dex_SEEN[] = _("{JPN}みた");
static const u8 sText_Dex_OWN[] = _("{JPN}つかまえた");
...
static const u8 sText_EVO_Buttons_PE[] = _("{JPN}{DPAD_UPDOWN}しんか  {A_BUTTON}みる  {START_BUTTON}すがた");
static const u8 sText_EVO_Buttons_Decapped_PE[] = _("{JPN}{DPAD_UPDOWN}しんか  {A_BUTTON}みる  {START_BUTTON}すがた");
static const u8 sText_EVO_Name[] = _("{JPN}{STR_VAR_3}");
static const u8 sText_EVO_PreEvo[] = _("{JPN}{STR_VAR_1}は {STR_VAR_2}から しんか");
static const u8 sText_EVO_PreEvo_PE_Mega[] = _("{JPN}{STR_VAR_1}は {STR_VAR_2}で メガシンカ");
static const u8 sText_EVO_FRIENDSHIP[] = _("{JPN}{LV}{UP_ARROW} なつきどが たかい");
static const u8 sText_EVO_FRIENDSHIP_DAY[] = _("{JPN}{LV}{UP_ARROW} なつきどが たかい ひるま");
static const u8 sText_EVO_FRIENDSHIP_NIGHT[] = _("{JPN}{LV}{UP_ARROW} なつきどが たかい よる");
static const u8 sText_EVO_FRIENDSHIP_MOVE_TYPE[] = _("{JPN}{LV}{UP_ARROW} なつきどが たかい {STR_VAR_2}を おぼえて いる");
static const u8 sText_EVO_LEVEL[] = _("{JPN}{LV}{UP_ARROW} {STR_VAR_2}に なる");
static const u8 sText_EVO_TRADE[] = _("{JPN}こうかん");
static const u8 sText_EVO_TRADE_ITEM[] = _("{JPN}{STR_VAR_2}を もたせて こうかん");
static const u8 sText_EVO_ITEM[] = _("{JPN}{STR_VAR_2}を つかう");
static const u8 sText_EVO_LEVEL_ATK_GT_DEF[] = _("{JPN}{LV}{UP_ARROW} {STR_VAR_2}に なる こうげきが ぼうぎょより うえ");
static const u8 sText_EVO_LEVEL_ATK_EQ_DEF[] = _("{JPN}{LV}{UP_ARROW} {STR_VAR_2}に なる こうげきと ぼうぎょが おなじ");
static const u8 sText_EVO_LEVEL_ATK_LT_DEF[] = _("{JPN}{LV}{UP_ARROW} {STR_VAR_2}に なる こうげきが ぼうぎょより した");
static const u8 sText_EVO_LEVEL_SILCOON[] = _("{JPN}{LV}{UP_ARROW} {STR_VAR_2}に なる カラサリスの せいしつ");
static const u8 sText_EVO_LEVEL_CASCOON[] = _("{JPN}{LV}{UP_ARROW} {STR_VAR_2}に なる マユルドの せいしつ");
static const u8 sText_EVO_LEVEL_NINJASK[] = _("{JPN}{LV}{UP_ARROW} {STR_VAR_2}に なる");
static const u8 sText_EVO_LEVEL_SHEDINJA[] = _("{JPN}{LV}{UP_ARROW} {STR_VAR_2}に なる てもち 6ぴき みまん モンスターボール 1こ");
static const u8 sText_EVO_BEAUTY[] = _("{JPN}{LV}{UP_ARROW} うつくしさが たかい");
static const u8 sText_EVO_LEVEL_FEMALE[] = _("{JPN}{LV}{UP_ARROW} {STR_VAR_2}に なる メス");
static const u8 sText_EVO_LEVEL_MALE[] = _("{JPN}{LV}{UP_ARROW} {STR_VAR_2}に なる オス");
static const u8 sText_EVO_LEVEL_NIGHT[] = _("{JPN}{LV}{UP_ARROW} {STR_VAR_2}に なる よる");
static const u8 sText_EVO_LEVEL_DAY[] = _("{JPN}{LV}{UP_ARROW} {STR_VAR_2}に なる ひるま");
static const u8 sText_EVO_LEVEL_DUSK[] = _("{JPN}{LV}{UP_ARROW} {STR_VAR_2}に なる ゆうがた 17じから 18じ");
static const u8 sText_EVO_ITEM_HOLD_DAY[] = _("{JPN}{LV}{UP_ARROW} {STR_VAR_2}を もつ ひるま");
static const u8 sText_EVO_ITEM_HOLD_NIGHT[] = _("{JPN}{LV}{UP_ARROW} {STR_VAR_2}を もつ よる");
static const u8 sText_EVO_MOVE[] = _("{JPN}{LV}{UP_ARROW} {STR_VAR_2}を おぼえて いる");
static const u8 sText_EVO_MAPSEC[] = _("{JPN}{STR_VAR_2}で {LV}{UP_ARROW}");
static const u8 sText_EVO_ITEM_MALE[] = _("{JPN}オスに {STR_VAR_2}を つかう");
static const u8 sText_EVO_ITEM_FEMALE[] = _("{JPN}メスに {STR_VAR_2}を つかう");
static const u8 sText_EVO_LEVEL_RAIN[] = _("{JPN}あめの とき {LV}{UP_ARROW} {STR_VAR_2}に なる");
static const u8 sText_EVO_SPECIFIC_MON_IN_PARTY[] = _("{JPN}てもちに {STR_VAR_2}が いる じょうたいで {LV}{UP_ARROW}");
static const u8 sText_EVO_LEVEL_DARK_TYPE_MON_IN_PARTY[] = _("{JPN}てもちに あくタイプが いる じょうたいで {LV}{UP_ARROW}");
static const u8 sText_EVO_TRADE_SPECIFIC_MON[] = _("{JPN}{STR_VAR_2}と こうかん");
static const u8 sText_EVO_SPECIFIC_MAP[] = _("{JPN}{STR_VAR_2}で {LV}{UP_ARROW}");
static const u8 sText_EVO_LEVEL_NATURE_AMPED[] = _("{JPN}{LV}{UP_ARROW} {STR_VAR_2}に なる ハイなせいかく");
static const u8 sText_EVO_LEVEL_NATURE_LOW_KEY[] = _("{JPN}{LV}{UP_ARROW} {STR_VAR_2}に なる ローなせいかく");
static const u8 sText_EVO_CRITICAL_HITS[] = _("{JPN}シングルバトルで きゅうしょに\n{STR_VAR_2}かい あてる");
static const u8 sText_EVO_SCRIPT_TRIGGER_DMG[] = _("{JPN}{STR_VAR_2}いじょうの ダメージを うける");
static const u8 sText_EVO_DARK_SCROLL[] = _("{JPN}あんこくのかけじくを つかう");
static const u8 sText_EVO_WATER_SCROLL[] = _("{JPN}すいりゅうのかけじくを つかう");
static const u8 sText_EVO_ITEM_NIGHT[] = _("{JPN}よる {STR_VAR_2}を つかう");
static const u8 sText_EVO_ITEM_DAY[] = _("{JPN}ひるま {STR_VAR_2}を つかう");
static const u8 sText_EVO_ITEM_HOLD[] = _("{JPN}{LV}{UP_ARROW} {STR_VAR_2}を もつ");
static const u8 sText_EVO_UNKNOWN[] = _("{JPN}しんかの しかたは ふめい");
static const u8 sText_EVO_NONE[] = _("{JPN}{STR_VAR_1}は しんか しません。");

static const u8 sText_FORMS_Buttons_PE[] = _("{JPN}{A_BUTTON}すがた  {START_BUTTON}しんか");
static const u8 sText_FORMS_Buttons_Decapped_PE[] = _("{JPN}{START_BUTTON}しんか");
static const u8 sText_FORMS_Buttons_Submenu_PE[] = _("{JPN}{DPAD_NONE}すがた {A_BUTTON}みる {START_BUTTON}しんか");
static const u8 sText_FORMS_Buttons_Submenu_Decapped_PE[] = _("{JPN}{START_BUTTON}しんか");
static const u8 sText_FORMS_NONE[] = _("{JPN}{STR_VAR_1}に べつの すがたは ありません。");
