...
static const u8 LandmarkName_FlowerShop[] = _("{JPN}はなや");
static const u8 LandmarkName_PetalburgWoods[] = _("{JPN}トウカのもり");
static const u8 LandmarkName_MrBrineysCottage[] = _("{JPN}ウシオの こや");
static const u8 LandmarkName_AbandonedShip[] = _("{JPN}すてられぶね");
static const u8 LandmarkName_SeashoreHouse[] = _("{JPN}かいはまハウス");
static const u8 LandmarkName_SlateportBeach[] = _("{JPN}カイナの はまべ");
static const u8 LandmarkName_CyclingRoad[] = _("{JPN}じてんしゃロード");
static const u8 LandmarkName_NewMauville[] = _("{JPN}ニューキンセツ");
static const u8 LandmarkName_TrickHouse[] = _("{JPN}カラクリやしき");
static const u8 LandmarkName_OldLadysRestShop[] = _("{JPN}おばあさんの ちゃや");
static const u8 LandmarkName_Desert[] = _("{JPN}さばく");
static const u8 LandmarkName_WinstrateFamily[] = _("{JPN}カラテかぞくの いえ");
...
static const u8 LandmarkName_TunnelersRestHouse[] = _("{JPN}トンネルの きゅうけいじょ");
static const u8 LandmarkName_RusturfTunnel[] = _("{JPN}カナシダトンネル");
static const u8 LandmarkName_PokemonDayCare[] = _("{JPN}ポケモンの あずかりや");
static const u8 LandmarkName_SafariZoneEntrance[] = _("{JPN}サファリゾーン いりぐち");
static const u8 LandmarkName_MtPyre[] = _("{JPN}おくりびやま");
static const u8 LandmarkName_ShoalCave[] = _("{JPN}すいちゅうどうくつ");
static const u8 LandmarkName_SeafloorCavern[] = _("{JPN}かいていどうくつ");
static const u8 LandmarkName_GraniteCave[] = _("{JPN}いしのどうくつ");
static const u8 LandmarkName_OceanCurrent[] = _("{JPN}かいりゅう");
static const u8 LandmarkName_LanettesHouse[] = _("{JPN}ナナミの いえ");
static const u8 LandmarkName_FieryPath[] = _("{JPN}ほのおのぬけみち");
static const u8 LandmarkName_JaggedPass[] = _("{JPN}ゴツゴツやまみち");
static const u8 LandmarkName_SkyPillar[] = _("{JPN}そらのはしら");
static const u8 LandmarkName_BerryMastersHouse[] = _("{JPN}きのみはかせの いえ");
static const u8 LandmarkName_IslandCave[] = _("{JPN}しまの ほらあな");
static const u8 LandmarkName_DesertRuins[] = _("{JPN}さばくの いせき");
static const u8 LandmarkName_ScorchedSlab[] = _("{JPN}ひでりの いわば");
static const u8 LandmarkName_AncientTomb[] = _("{JPN}いにしえの はか");
static const u8 LandmarkName_SealedChamber[] = _("{JPN}ふういんの しつ");
static const u8 LandmarkName_FossilManiacsHouse[] = _("{JPN}かせきマニアの いえ");
static const u8 LandmarkName_HuntersHouse[] = _("{JPN}ハンターの いえ");
static const u8 LandmarkName_MagmaHideout[] = _("{JPN}マグマだんの アジト");
static const u8 LandmarkName_MirageTower[] = _("{JPN}しんきろうの とう");
static const u8 LandmarkName_AlteringCave[] = _("{JPN}ふしぎな どうくつ");
static const u8 LandmarkName_DesertUnderpass[] = _("{JPN}さばくの ちかどう");
