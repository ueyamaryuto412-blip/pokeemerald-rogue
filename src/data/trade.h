...
static const u8 sText_SpaceMove[] = _("{JPN} わざ"); // unused
static const u8 sText_NewLine[] = _("\n");
static const u8 sText_Slash[] = _("/");
static const u8 sText_Lv[] = _("{JPN}{LV}");
static const u8 sText_ThreeDashes[] = _("---");
static const u8 sText_FourQuestionMarks[] = _("????");
static const u8 sText_UnusedEmpty[] = _("");
static const u8 sText_IsThisTradeOkay[] = _("{JPN}この こうかんで いいですか?");
static const u8 sText_Cancel[] = _("{JPN}やめる");
static const u8 sText_ChooseAPkmn[] = _("{JPN}ポケモンを えらんで ください。");
static const u8 sText_Summary[] = _("{JPN}つよさを みる");
static const u8 sText_Trade[] = _("{JPN}こうかん");
static const u8 sText_CancelTrade[] = _("{JPN}こうかんを やめますか?");
static const u8 sJPText_PressBButtonToQuit[] = _("Bボタン　で　もどります");
static const u8 sText_Summary2[] = _("{JPN}つよさを みる");
static const u8 sText_Trade2[] = _("{JPN}こうかん");
static const u8 sText_CommunicationStandby[] = _("{JPN}{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}つうしん たいきちゅう…\nおまち ください。");
static const u8 sText_TheTradeHasBeenCanceled[] = _("{JPN}{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}こうかんは\nちゅうし されました。");
static const u8 sText_OnlyPkmnForBattle[] = _("{JPN}それは たたかえる\nさいごの ポケモンだ。");
static const u8 sText_WaitingForYourFriend[] = _("{JPN}{COLOR DARK_GRAY}{HIGHLIGHT WHITE}{SHADOW LIGHT_GRAY}あいての そうさが\nおわるのを まって います…");
static const u8 sText_YourFriendWantsToTrade[] = _("{JPN}あいてが ポケモンを\nこうかん したがって います。");
