...
{
    {
        .name = {_("サダヒロ"), _("{JPN}アラン"), _("{JPN}アラン"), _("{JPN}アデルフォ"), _("{JPN}クラウス"), _("{JPN}テオ")},
        .otId = 0xBDC9,
    ...
    {
        .name = {_("ヒロオ"), _("{JPN}ライオネル"), _("{JPN}ライオネル"), _("{JPN}カイオ"), _("{JPN}ルドビヒ"), _("{JPN}レオ")},
        .otId = 0xCF09,
    ...
    {
        .name = {_("ケイジ"), _("{JPN}サニー"), _("{JPN}エルベ"), _("{JPN}フェドロ"), _("{JPN}ベンツェル"), _("{JPN}サンティ")},
        .otId = 0x2E34,
    ...
    {
        .name = {_("ユラ"), _("{JPN}レイラ"), _("{JPN}レイラ"), _("{JPN}アストリド"), _("{JPN}ソニア"), _("{JPN}ローラ")},
        .otId = 0x84EF,
    ...
    {
        .name = {_("ヨウカ"), _("{JPN}メイシー"), _("{JPN}アメリ"), _("{JPN}クレオ"), _("{JPN}マリア"), _("{JPN}エリサ")},
        .otId = 0x1E43,
    ...
    {
        .name = {_("ヤスシ"), _("{JPN}ドンテ"), _("{JPN}ブラヒム"), _("{JPN}グラウコ"), _("{JPN}ヨーゼフ"), _("{JPN}ロケ")},
        .otId = 0x379F,
    ...
    {
        .name = {_("ミサオ"), _("{JPN}アミラ"), _("{JPN}ロール"), _("{JPN}ダフネ"), _("{JPN}アメリ"), _("{JPN}ララ")},
        .otId = 0xF555,
    ...
    {
        .name = {_("カズサ"), _("{JPN}カリ"), _("{JPN}ジョディ"), _("{JPN}イレニア"), _("{JPN}カロ"), _("{JPN}エルサ")},
        .otId = 0x8D26,
    ...
    {
        .name = {_("スミレ"), _("{JPN}アニー"), _("{JPN}アニー"), _("{JPN}イメルダ"), _("{JPN}イネス"), _("{JPN}ローザ")},
        .otId = 0x800C,
    ...
    {
        .name = {_("アキノリ"), _("{JPN}ディレン"), _("{JPN}ルネ"), _("{JPN}インドロ"), _("{JPN}デトレフ"), _("{JPN}ペドロ")},
        .otId = 0x469f,
    ...
    {
        .name = {_("トウゾウ"), _("{JPN}ダラス"), _("{JPN}ブルーノ"), _("{JPN}レアルコ"), _("{JPN}アンスガ"), _("{JPN}マノロ")},
        .otId = 0x71FC,
    ...
    {
        .name = {_("セイヤ"), _("{JPN}フランク"), _("{JPN}フランク"), _("{JPN}オリンド"), _("{JPN}フランク"), _("{JPN}マウロ")},
        .otId = 0xA39E,
    ...
    {
        .name = {_("リュウジ"), _("{JPN}ラモント"), _("{JPN}ザブ"), _("{JPN}オルフェオ"), _("{JPN}ユルゲン"), _("{JPN}ホルヘ")},
        .otId = 0xE590,
    ...
    {
        .name = {_("カツアキ"), _("{JPN}タイリース"), _("{JPN}アンディ"), _("{JPN}パリデ"), _("{JPN}デイビド"), _("{JPN}チチョ")},
        .otId = 0xD018,
    ...
    {
        .name = {_("トシミツ"), _("{JPN}ダンテ"), _("{JPN}ダンテ"), _("{JPN}ラウル"), _("{JPN}ロタール"), _("{JPN}パブロ")},
        .otId = 0xBC75,
    ...
    {
        .name = {_("ローウェン"), _("{JPN}アルトゥロ"), _("{JPN}アルトゥロ"), _("{JPN}ロモロ"), _("{JPN}ブライアン"), _("{JPN}アルトゥロ")},
        .otId = 0xFA02,
