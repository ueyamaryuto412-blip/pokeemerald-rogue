const u8 gEasyChatWord_IChooseYou[] = _("{JPN}きみに きめた");
const u8 gEasyChatWord_Gotcha[] = _("{JPN}やったぜ");
const u8 gEasyChatWord_Trade[] = _("{JPN}こうかん");
const u8 gEasyChatWord_Sapphire[] = _("{JPN}サファイア");
const u8 gEasyChatWord_Evolve[] = _("{JPN}しんか");
const u8 gEasyChatWord_Encyclopedia[] = _("{JPN}ずかん");
const u8 gEasyChatWord_Nature[] = _("{JPN}せいかく");
const u8 gEasyChatWord_Center[] = _("{JPN}センター");
const u8 gEasyChatWord_Egg[] = _("{JPN}タマゴ");
const u8 gEasyChatWord_Link[] = _("{JPN}つうしん");
const u8 gEasyChatWord_SpAbility[] = _("{JPN}とくせい");
const u8 gEasyChatWord_Trainer[] = _("{JPN}トレーナー");
const u8 gEasyChatWord_Version[] = _("{JPN}バージョン");
const u8 gEasyChatWord_Pokenav[] = _("{JPN}ポケナビ");
const u8 gEasyChatWord_Pokemon[] = _("{JPN}ポケモン");
const u8 gEasyChatWord_Get[] = _("{JPN}てにいれる");
const u8 gEasyChatWord_Pokedex[] = _("{JPN}ポケモンずかん");
const u8 gEasyChatWord_Ruby[] = _("{JPN}ルビー");
const u8 gEasyChatWord_Level[] = _("{JPN}レベル");
const u8 gEasyChatWord_Red[] = _("{JPN}レッド");
const u8 gEasyChatWord_Green[] = _("{JPN}みどり");
const u8 gEasyChatWord_Bag[] = _("{JPN}バッグ");
const u8 gEasyChatWord_Flame[] = _("{JPN}ほのお");
