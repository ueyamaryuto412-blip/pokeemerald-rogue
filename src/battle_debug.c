...
static const u8 sText_Uproar[] = _("{JPN}さわぐ");
static const u8 sText_Bide[] = _("{JPN}がまん");
static const u8 sText_LockConfuse[] = _("Lock Confuse");
static const u8 sText_MultipleTurns[] = _("MultipleTurns");
static const u8 sText_FocusEnergy[] = _("{JPN}きあいだめ");
static const u8 sText_Transformed[] = _("Transformed");
static const u8 sText_Recharge[] = _("Recharge");
static const u8 sText_Rage[] = _("{JPN}いかり");
static const u8 sText_Substitute[] = _("{JPN}みがわり");
static const u8 sText_SubstituteHp[] = _("Substitute HP");
static const u8 sText_DestinyBond[] = _("{JPN}みちづれ");
static const u8 sText_CantEscape[] = _("Cant Escape");
static const u8 sText_Nightmare[] = _("{JPN}あくむ");
...
static const u8 sText_Imprisoned[] = _("{JPN}ふういん");
static const u8 sText_Reflect[] = _("{JPN}リフレクター");
static const u8 sText_LightScreen[] = _("{JPN}ひかりのかべ");
static const u8 sText_Spikes[] = _("{JPN}まきびし");
static const u8 sText_Safeguard[] = _("{JPN}しんぴのまもり");
static const u8 sText_Mist[] = _("{JPN}しろいきり");
static const u8 sText_ShowOpponentHP[] = _("Opponent Hp");
static const u8 sText_Types[] = _("Types");
static const u8 sText_GastroAcid[] = _("{JPN}いえき");
static const u8 sText_SmackDown[] = _("Smacked Down");
static const u8 sText_MiracleEye[] = _("{JPN}ミラクルアイ");
static const u8 sText_AquaRing[] = _("{JPN}アクアリング");
static const u8 sText_LaserFocus[] = _("Laser Focused");
static const u8 sText_Electrified[] = _("Electrified");
static const u8 sText_AuroraVeil[] = _("{JPN}オーロラベール");
static const u8 sText_LuckyChant[] = _("{JPN}おまじない");
static const u8 sText_Tailwind[] = _("{JPN}おいかぜ");
static const u8 sText_PP[] = _("PP");
static const u8 sText_StealthRock[] = _("{JPN}ステルスロック");
static const u8 sText_ToxicSpikes[] = _("{JPN}どくびし");
static const u8 sText_StickyWeb[] = _("{JPN}ねばねばネット");
...
static const u8 sText_PreferBatonPass[] = _("{JPN}バトンタッチ");
...
static const u8 sText_HoldEffectMachoBrace[] = _("{JPN}きょうせいギプス");
static const u8 sText_HoldEffectExpShare[] = _("Exp Share");
static const u8 sText_HoldEffectQuickClaw[] = _("{JPN}せんせいのツメ");
static const u8 sText_HoldEffectFriendshipUp[] = _("Friendship Up");
static const u8 sText_HoldEffectMentalHerb[] = _("{JPN}メンタルハーブ");
static const u8 sText_HoldEffectChoiceBand[] = _("{JPN}こだわりハチマキ");
...
static const u8 sText_HoldEffectRepel[] = _("{JPN}むしよけスプレー");
static const u8 sText_HoldEffectSoulDew[] = _("{JPN}こころのしずく");
...
static const u8 sText_HoldEffectFocusBand[] = _("{JPN}きあいのハチマキ");
static const u8 sText_HoldEffectLuckyEgg[] = _("{JPN}しあわせタマゴ");
static const u8 sText_HoldEffectScopeLens[] = _("{JPN}ピントレンズ");
static const u8 sText_HoldEffectSteelPower[] = _("Steel Power");
static const u8 sText_HoldEffectLeftovers[] = _("{JPN}たべのこし");
static const u8 sText_HoldEffectDragonScale[] = _("{JPN}りゅうのウロコ");
static const u8 sText_HoldEffectLightBall[] = _("{JPN}でんきだま");
...
static const u8 sText_HoldEffectUpgrade[] = _("{JPN}アップグレード");
static const u8 sText_HoldEffectShellBell[] = _("{JPN}かいがらのすず");
static const u8 sText_HoldEffectLuckyPunch[] = _("{JPN}ラッキーパンチ");
static const u8 sText_HoldEffectMetalPowder[] = _("{JPN}メタルパウダー");
static const u8 sText_HoldEffectThickClub[] = _("{JPN}ふといホネ");
static const u8 sText_HoldEffectLeek[] = _("{JPN}ながねぎ");
static const u8 sText_HoldEffectChoiceScarf[] = _("{JPN}こだわりスカーフ");
static const u8 sText_HoldEffectChoiceSpecs[] = _("{JPN}こだわりメガネ");
static const u8 sText_HoldEffectDampRock[] = _("{JPN}しめったいわ");
static const u8 sText_HoldEffectGripClaw[] = _("{JPN}ねばりのかぎづめ");
static const u8 sText_HoldEffectHeatRock[] = _("{JPN}あついいわ");
static const u8 sText_HoldEffectIcyRock[] = _("{JPN}つめたいいわ");
static const u8 sText_HoldEffectLightClay[] = _("{JPN}ひかりのねんど");
static const u8 sText_HoldEffectSmoothRock[] = _("{JPN}さらさらいわ");
static const u8 sText_HoldEffectPowerHerb[] = _("{JPN}パワフルハーブ");
static const u8 sText_HoldEffectBigRoot[] = _("{JPN}おおきなねっこ");
static const u8 sText_HoldEffectExpertBelt[] = _("{JPN}たつじんのおび");
static const u8 sText_HoldEffectLifeOrb[] = _("{JPN}いのちのたま");
static const u8 sText_HoldEffectMetronome[] = _("{JPN}ゆびをふる");
static const u8 sText_HoldEffectMuscleBand[] = _("{JPN}ちからのハチマキ");
static const u8 sText_HoldEffectWideLens[] = _("{JPN}こうかくレンズ");
static const u8 sText_HoldEffectWiseGlasses[] = _("{JPN}ものしりメガネ");
static const u8 sText_HoldEffectZoomLens[] = _("{JPN}フォーカスレンズ");
static const u8 sText_HoldEffectLaggingTail[] = _("{JPN}こうこうのしっぽ");
static const u8 sText_HoldEffectFocusSash[] = _("{JPN}きあいのタスキ");
static const u8 sText_HoldEffectFlameOrb[] = _("{JPN}かえんだま");
static const u8 sText_HoldEffectToxicOrb[] = _("{JPN}どくどくだま");
static const u8 sText_HoldEffectStickyBarb[] = _("{JPN}くっつきバリ");
static const u8 sText_HoldEffectIronBall[] = _("{JPN}くろいてっきゅう");
static const u8 sText_HoldEffectBlackSludge[] = _("{JPN}くろいヘドロ");
static const u8 sText_HoldEffectDestinyKnot[] = _("{JPN}あかいいと");
static const u8 sText_HoldEffectShedShell[] = _("{JPN}きれいなぬけがら");
static const u8 sText_HoldEffectQuickPowder[] = _("{JPN}スピードパウダー");
static const u8 sText_HoldEffectAdamantOrb[] = _("{JPN}こんごうだま");
static const u8 sText_HoldEffectLustrousOrb[] = _("{JPN}しらたま");
static const u8 sText_HoldEffectGriseousOrb[] = _("{JPN}はっきんだま");
static const u8 sText_HoldEffectEnigmaBerry[] = _("{JPN}ナゾのみ");
...
static const u8 sText_HoldEffectMicleBerry[] = _("{JPN}ミクルのみ");
static const u8 sText_HoldEffectCustapBerry[] = _("{JPN}イバンのみ");
static const u8 sText_HoldEffectJabocaBerry[] = _("{JPN}ジャポのみ");
static const u8 sText_HoldEffectRowapBerry[] = _("{JPN}レンブのみ");
static const u8 sText_HoldEffectKeeBerry[] = _("{JPN}アッキのみ");
static const u8 sText_HoldEffectMarangaBerry[] = _("{JPN}タラプのみ");
static const u8 sText_HoldEffectFloatStone[] = _("{JPN}かるいし");
static const u8 sText_HoldEffectEviolite[] = _("{JPN}しんかのきせき");
static const u8 sText_HoldEffectAssaultVest[] = _("{JPN}とつげきチョッキ");
static const u8 sText_HoldEffectDrive[] = _("Drive");
static const u8 sText_HoldEffectGems[] = _("Gems");
static const u8 sText_HoldEffectRockyHelmet[] = _("{JPN}ゴツゴツメット");
static const u8 sText_HoldEffectAirBalloon[] = _("{JPN}ふうせん");
static const u8 sText_HoldEffectRedCard[] = _("{JPN}レッドカード");
static const u8 sText_HoldEffectRingTarget[] = _("{JPN}ねらいのまと");
static const u8 sText_HoldEffectBindingBand[] = _("{JPN}しめつけバンド");
static const u8 sText_HoldEffectEjectButton[] = _("{JPN}だっしゅつボタン");
static const u8 sText_HoldEffectAbsorbBulb[] = _("{JPN}きゅうこん");
static const u8 sText_HoldEffectCellBattery[] = _("{JPN}じゅうでんち");
...
static const u8 sText_HoldEffectLuminousMoss[] = _("{JPN}ひかりごけ");
static const u8 sText_HoldEffectSnowball[] = _("{JPN}ゆきだま");
...
static const u8 sText_HoldEffectEjectPack[] = _("{JPN}だっしゅつパック");
static const u8 sText_HoldEffectRoomService[] = _("{JPN}ルームサービス");
...
static const u8 sText_HoldEffectThroatSpray[] = _("{JPN}のどスプレー");
