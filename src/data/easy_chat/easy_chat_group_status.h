...
const u8 gEasyChatWord_Beauty[] = _("{JPN}うつくしさ");
...
const u8 gEasyChatWord_Grass[] = _("{JPN}しょくぶつ");
...
const u8 gEasyChatWord_Tough[] = _("{JPN}たくましさ");
...
const u8 gEasyChatWord_Dragon[] = _("{JPN}ドラゴン");
...
const u8 gEasyChatWord_Normal[] = _("{JPN}ノーマル");
...
const u8 gEasyChatWord_Flying[] = _("{JPN}ひこう");
...
const u8 gEasyChatWord_Bug[] = _("{JPN}むし");
