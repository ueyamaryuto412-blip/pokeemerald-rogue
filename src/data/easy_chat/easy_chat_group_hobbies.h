const u8 gEasyChatWord_Idol[] = _("{JPN}アイドル");
const u8 gEasyChatWord_Anime[] = _("{JPN}アニメ");
const u8 gEasyChatWord_Song[] = _("{JPN}うた");
const u8 gEasyChatWord_Movie[] = _("{JPN}えいが");
const u8 gEasyChatWord_Sweets[] = _("{JPN}おかし");
const u8 gEasyChatWord_Chat[] = _("{JPN}チャット");
const u8 gEasyChatWord_ChildsPlay[] = _("{JPN}こどもの あそび");
const u8 gEasyChatWord_Toys[] = _("{JPN}おもちゃ");
const u8 gEasyChatWord_Music[] = _("{JPN}おんがく");
const u8 gEasyChatWord_Cards[] = _("{JPN}カード");
const u8 gEasyChatWord_Shopping[] = _("{JPN}かいもの");
const u8 gEasyChatWord_Camera[] = _("{JPN}カメラ");
const u8 gEasyChatWord_Viewing[] = _("{JPN}けんぶつ");
const u8 gEasyChatWord_Spectator[] = _("{JPN}かんきゃく");
const u8 gEasyChatWord_Gourmet[] = _("{JPN}グルメ");
const u8 gEasyChatWord_Game[] = _("{JPN}ゲーム");
const u8 gEasyChatWord_Rpg[] = _("{JPN}RPG");
const u8 gEasyChatWord_Collection[] = _("{JPN}コレクション");
const u8 gEasyChatWord_Complete[] = _("{JPN}コンプリート");
const u8 gEasyChatWord_Magazine[] = _("{JPN}ざっし");
const u8 gEasyChatWord_Walk[] = _("{JPN}さんぽ");
const u8 gEasyChatWord_Bike[] = _("{JPN}じてんしゃ");
const u8 gEasyChatWord_Hobby[] = _("{JPN}しゅみ");
const u8 gEasyChatWord_Sports[] = _("{JPN}スポーツ");
const u8 gEasyChatWord_Software[] = _("{JPN}ソフト");
const u8 gEasyChatWord_Songs[] = _("{JPN}うたたち");
const u8 gEasyChatWord_Diet[] = _("{JPN}ダイエット");
const u8 gEasyChatWord_Treasure[] = _("{JPN}たからもの");
const u8 gEasyChatWord_Travel[] = _("{JPN}たび");
const u8 gEasyChatWord_Dance[] = _("{JPN}ダンス");
const u8 gEasyChatWord_Channel[] = _("{JPN}チャンネル");
const u8 gEasyChatWord_Making[] = _("{JPN}つくること");
const u8 gEasyChatWord_Fishing[] = _("{JPN}つり");
const u8 gEasyChatWord_Date[] = _("{JPN}デート");
const u8 gEasyChatWord_Design[] = _("{JPN}デザイン");
const u8 gEasyChatWord_Locomotive[] = _("{JPN}きかんしゃ");
const u8 gEasyChatWord_PlushDoll[] = _("{JPN}ぬいぐるみ");
const u8 gEasyChatWord_Pc[] = _("{JPN}パソコン");
const u8 gEasyChatWord_Flowers[] = _("{JPN}はな");
const u8 gEasyChatWord_Hero[] = _("{JPN}ヒーロー");
const u8 gEasyChatWord_Nap[] = _("{JPN}ひるね");
const u8 gEasyChatWord_Heroine[] = _("{JPN}ヒロイン");
const u8 gEasyChatWord_Fashion[] = _("{JPN}ファッション");
const u8 gEasyChatWord_Adventure[] = _("{JPN}ぼうけん");
const u8 gEasyChatWord_Board[] = _("{JPN}ボード");
const u8 gEasyChatWord_Ball[] = _("{JPN}ボール");
const u8 gEasyChatWord_Book[] = _("{JPN}ほん");
const u8 gEasyChatWord_Festival[] = _("{JPN}まつり");
const u8 gEasyChatWord_Comics[] = _("{JPN}まんが");
const u8 gEasyChatWord_Holiday[] = _("{JPN}やすみ");
const u8 gEasyChatWord_Plans[] = _("{JPN}よてい");
const u8 gEasyChatWord_Trendy[] = _("{JPN}りゅうこう");
const u8 gEasyChatWord_Vacation[] = _("{JPN}きゅうか");
const u8 gEasyChatWord_Look[] = _("{JPN}みため");
