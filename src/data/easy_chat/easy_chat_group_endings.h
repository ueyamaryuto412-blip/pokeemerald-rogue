const u8 gEasyChatWord_Will[] = _("{JPN}だろう");
const u8 gEasyChatWord_WillBeHere[] = _("{JPN}いるだろう");
const u8 gEasyChatWord_Or[] = _("{JPN}または");
const u8 gEasyChatWord_Times[] = _("{JPN}かい");
const u8 gEasyChatWord_Wonder[] = _("{JPN}かしら");
const u8 gEasyChatWord_IsItQues[] = _("{JPN}かな?");
const u8 gEasyChatWord_Be[] = _("{JPN}なる");
const u8 gEasyChatWord_Gimme[] = _("{JPN}ちょうだい");
const u8 gEasyChatWord_Could[] = _("{JPN}できた");
const u8 gEasyChatWord_LikelyTo[] = _("{JPN}しそう");
const u8 gEasyChatWord_Would[] = _("{JPN}でしょう");
const u8 gEasyChatWord_Is[] = _("{JPN}です");
const u8 gEasyChatWord_IsntItQues[] = _("{JPN}だよね?");
const u8 gEasyChatWord_Lets[] = _("{JPN}やろう");
const u8 gEasyChatWord_Other[] = _("{JPN}ほかの");
const u8 gEasyChatWord_Are[] = _("{JPN}です");
const u8 gEasyChatWord_Was[] = _("{JPN}だった");
const u8 gEasyChatWord_Were[] = _("{JPN}でした");
const u8 gEasyChatWord_Those[] = _("{JPN}あれら");
const u8 gEasyChatWord_Isnt[] = _("{JPN}ではない");
const u8 gEasyChatWord_Wont[] = _("{JPN}しない");
const u8 gEasyChatWord_Cant[] = _("{JPN}できない");
const u8 gEasyChatWord_Can[] = _("{JPN}できる");
const u8 gEasyChatWord_Dont[] = _("{JPN}しないで");
const u8 gEasyChatWord_Do[] = _("{JPN}する");
const u8 gEasyChatWord_Does[] = _("{JPN}します");
const u8 gEasyChatWord_Whom[] = _("{JPN}だれに");
const u8 gEasyChatWord_Which[] = _("{JPN}どっち");
const u8 gEasyChatWord_Wasnt[] = _("{JPN}ではなかった");
const u8 gEasyChatWord_Werent[] = _("{JPN}ではなかった");
const u8 gEasyChatWord_Have[] = _("{JPN}もって いる");
const u8 gEasyChatWord_Havent[] = _("{JPN}もって いない");
const u8 gEasyChatWord_A[] = _("A");
const u8 gEasyChatWord_An[] = _("{JPN}ひとつの");
const u8 gEasyChatWord_Not[] = _("{JPN}ない");
const u8 gEasyChatWord_There[] = _("{JPN}そこ");
const u8 gEasyChatWord_OkQues[] = _("{JPN}いい?");
const u8 gEasyChatWord_So[] = _("{JPN}だから");
const u8 gEasyChatWord_Maybe[] = _("{JPN}たぶん");
const u8 gEasyChatWord_About[] = _("{JPN}について");
const u8 gEasyChatWord_Over[] = _("{JPN}こえて");
const u8 gEasyChatWord_It[] = _("{JPN}それ");
const u8 gEasyChatWord_All[] = _("{JPN}ぜんぶ");
const u8 gEasyChatWord_For[] = _("{JPN}のために");
const u8 gEasyChatWord_On[] = _("{JPN}のうえ");
const u8 gEasyChatWord_Off[] = _("{JPN}オフ");
const u8 gEasyChatWord_As[] = _("{JPN}として");
const u8 gEasyChatWord_To[] = _("{JPN}へ");
const u8 gEasyChatWord_With[] = _("{JPN}といっしょに");
const u8 gEasyChatWord_Better[] = _("{JPN}もっと いい");
const u8 gEasyChatWord_Ever[] = _("{JPN}いままで");
const u8 gEasyChatWord_Since[] = _("{JPN}それから");
const u8 gEasyChatWord_Of[] = _("{JPN}の");
const u8 gEasyChatWord_BelongsTo[] = _("{JPN}のもの");
const u8 gEasyChatWord_At[] = _("{JPN}で");
const u8 gEasyChatWord_In[] = _("{JPN}のなか");
const u8 gEasyChatWord_Out[] = _("{JPN}そとへ");
const u8 gEasyChatWord_Too[] = _("{JPN}すぎる");
const u8 gEasyChatWord_Like[] = _("{JPN}みたいに");
const u8 gEasyChatWord_Did[] = _("{JPN}した");
const u8 gEasyChatWord_Didnt[] = _("{JPN}しなかった");
const u8 gEasyChatWord_Doesnt[] = _("{JPN}しません");
const u8 gEasyChatWord_Without[] = _("{JPN}なしで");
const u8 gEasyChatWord_After[] = _("{JPN}あとで");
const u8 gEasyChatWord_Before[] = _("{JPN}まえに");
const u8 gEasyChatWord_While[] = _("{JPN}あいだ");
const u8 gEasyChatWord_Than[] = _("{JPN}より");
const u8 gEasyChatWord_Once[] = _("{JPN}いちど");
const u8 gEasyChatWord_Anywhere[] = _("{JPN}どこでも");
