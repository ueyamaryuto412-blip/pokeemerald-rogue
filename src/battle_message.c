...
static const u8 sText_PkmnWasFrozen[] = _("{JPN}{B_EFF_NAME_WITH_PREFIX}は こおりついた!");
...
static const u8 sText_PkmnWasDefrosted[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}の こおりが とけた!");
static const u8 sText_PkmnWasDefrosted2[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}の こおりが とけた!");
static const u8 sText_PkmnWasDefrostedBy[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_CURRENT_MOVE}で\nこおりが とけた!");
static const u8 sText_PkmnFrostbiteHealed[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}の しもやけが なおった!");
static const u8 sText_PkmnFrostbiteHealed2[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}の しもやけが なおった!");
...
static const u8 sText_PkmnHealedParalysis[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}の まひが なおった!");
static const u8 sText_PkmnDreamEaten[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}の ゆめを たべた!");
...
static const u8 sText_PkmnIsConfused[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は こんらんして いる!");
static const u8 sText_PkmnHealedConfusion[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}の こんらんが とけた!");
static const u8 sText_PkmnWasConfused[] = _("{JPN}{B_EFF_NAME_WITH_PREFIX}は こんらんした!");
static const u8 sText_PkmnAlreadyConfused[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は すでに\nこんらんして いる!");
static const u8 sText_PkmnFellInLove[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は メロメロに なった!");
...
static const u8 sText_PkmnBlownAway[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は ふきとばされた!");
...
static const u8 sText_PkmnRegainedHealth[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は たいりょくを かいふくした!");
static const u8 sText_PkmnHPFull[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}の HPは まんたんだ!");
...
static const u8 sText_PkmnWentToSleep[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は ねむりはじめた!");
static const u8 sText_PkmnSleptHealthy[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は ねむって げんきに なった!");
static const u8 sText_PkmnWhippedWhirlwind[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は たつまきを おこした!");
static const u8 sText_PkmnTookSunlight[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は こうごうせいの\nじゅんびを した!");
static const u8 sText_PkmnLoweredHead[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は あたまを さげた!");
static const u8 sText_PkmnIsGlowing[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は ひかり かがやいた!");
static const u8 sText_PkmnFlewHigh[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は そらたかく とびあがった!");
static const u8 sText_PkmnDugHole[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は あなを ほって もぐった!");
static const u8 sText_PkmnHidUnderwater[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は みずに もぐった!");
...
static const u8 sText_PkmnInSnapTrap[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は トラップに かかった!");
static const u8 sText_PkmnTrappedInVortex[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は うずしおに つかまった!");
static const u8 sText_PkmnTrappedBySandTomb[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は すなじごくに つかまった!");
...
const u8 gText_PkmnShroudedInMist[] = _("{JPN}{B_ATK_PREFIX2}は しろいきりに つつまれた!");
static const u8 sText_PkmnProtectedByMist[] = _("{JPN}{B_SCR_ACTIVE_NAME_WITH_PREFIX}は しろいきりに\nまもられている!");
const u8 gText_PkmnGettingPumped[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は はりきっている!");
static const u8 sText_PkmnHitWithRecoil[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は はんどうで ダメージを うけた!");
static const u8 sText_PkmnProtectedItself2[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は みを まもっている!");
...
static const u8 sText_PkmnEvadedAttack[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は こうげきを かわした!");
static const u8 sText_PkmnSappedByLeechSeed[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は やどりぎに\nたいりょくを すいとられた!");
static const u8 sText_PkmnFastAsleep[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は ぐうぐう ねむっている。");
...
static const u8 sText_PkmnWokeUpInUproar[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は さわぎで めを さました!");
static const u8 sText_PkmnCausedUproar[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は さわぎはじめた!");
static const u8 sText_PkmnMakingUproar[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は さわいでいる!");
...
static const u8 sText_PkmnStockpiled[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_BUFF1}つ たくわえた!");
...
static const u8 sText_PkmnStoringEnergy[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は ちからを ためている!");
static const u8 sText_PkmnUnleashedEnergy[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は ためた ちからを はなった!");
static const u8 sText_PkmnFatigueConfusion[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は つかれで こんらんした!");
static const u8 sText_PlayerPickedUpMoney[] = _("{JPN}{B_PLAYER_NAME}は {B_BUFF1}¥を ひろった!\p");
static const u8 sText_PkmnUnaffected[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}には こうかが ない!");
static const u8 sText_PkmnTransformedInto[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_BUFF1}に へんしんした!");
static const u8 sText_PkmnMadeSubstitute[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は みがわりを だした!");
...
static const u8 sText_PkmnSubstituteFaded[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}の みがわりは きえた!\p");
static const u8 sText_PkmnMustRecharge[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は うごけない!");
...
static const u8 sText_PkmnMoveDisabledNoMore[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}の かなしばりが とけた!");
static const u8 sText_PkmnGotEncore[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は アンコールを うけた!");
static const u8 sText_PkmnEncoreEnded[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}の アンコールが おわった!");
...
static const u8 sText_TargetCantEscapeNow[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は もう にげられない!");
static const u8 sText_PkmnFellIntoNightmare[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は あくむを みはじめた!");
static const u8 sText_PkmnLockedInNightmare[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は あくむに うなされている!");
...
static const u8 sText_PkmnBracedItself[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は こうげきに そなえた!");
static const u8 sText_PkmnEnduredHit[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は こうげきを もちこたえた!");
...
static const u8 sText_PkmnShedLeechSeed[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は やどりぎを ふりはらった!");
static const u8 sText_PkmnBlewAwaySpikes[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は まきびしを ふきとばした!");
static const u8 sText_PkmnFledFromBattle[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は バトルから にげだした!");
static const u8 sText_PkmnForesawAttack[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は みらいに こうげきを よちした!");
...
static const u8 sText_PkmnCenterAttention[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}に ちゅうもくが あつまった!");
static const u8 sText_PkmnChargingPower[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は ちからを ためはじめた!");
static const u8 sText_NaturePowerTurnedInto[] = _("{JPN}しぜんのちからは {B_CURRENT_MOVE}に なった!");
static const u8 sText_PkmnStatusNormal[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}の のうりょくへんかが\nもとに もどった!");
static const u8 sText_PkmnSubjectedToTorment[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は いちゃもんを つけられた!");
static const u8 sText_PkmnTighteningFocus[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は しゅうちゅうを たかめている!");
static const u8 sText_PkmnFellForTaunt[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は ちょうはつに のった!");
...
static const u8 sText_PkmnObtainedX[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_BUFF1}を てに いれた。");
static const u8 sText_PkmnObtainedX2[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は {B_BUFF2}を てに いれた。");
static const u8 sText_PkmnObtainedXYObtainedZ[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_BUFF1}を てに いれた。\p{B_DEF_NAME_WITH_PREFIX}は {B_BUFF2}を てに いれた。");
...
static const u8 sText_PkmnShroudedItself[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_CURRENT_MOVE}に つつまれた!");
...
static const u8 sText_PkmnWasDraggedOut[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は ひきずりだされた!\p");
...
static const u8 sText_ItSuckedLiquidOoze[] = _("{JPN}ヘドロえきを すいこんだ!");
...
static const u8 sText_FailedToSpitUp[] = _("{JPN}しかし なにも はきださなかった!");
static const u8 sText_FailedToSwallow[] = _("{JPN}しかし なにも のみこめなかった!");
static const u8 sText_WindBecameHeatWave[] = _("{JPN}かぜは ねっぷうに かわった!");
...
static const u8 sText_SharedPain[] = _("{JPN}おたがいの いたみを わけあった!");
...
static const u8 sText_PkmnIgnoredOrders[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は めいれいを きかない!");
static const u8 sText_PkmnBeganToNap[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は いねむりを はじめた!");
static const u8 sText_PkmnLoafing[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は なまけている!");
static const u8 sText_PkmnWontObey[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は いうことを きかない!");
static const u8 sText_PkmnTurnedAway[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は そっぽを むいた!");
static const u8 sText_PkmnPretendNotNotice[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は きづかない ふりを した!");
...
static const u8 sText_PkmnLearnedMove2[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_BUFF1}を おぼえた!");
...
static const u8 sText_PkmnIsCalm[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}の いかりが おさまった");
...
static const u8 sText_TargetIdentified[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は みやぶられた!");
...
static const u8 sText_PkmnPreventedFromHealing[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は かいふくを ふうじられた!");
...
static const u8 sText_PkmnAcquiredAbility[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は {B_DEF_ABILITY}を てに いれた!");
...
static const u8 sText_PkmnSurroundedWithVeilOfWater[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は みずの ベールに つつまれた!");
static const u8 sText_PkmnLevitatedOnElectromagnetism[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は じりょくで うきあがった!");
static const u8 sText_PkmnTwistedDimensions[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は じくうを ゆがめた!");
...
static const u8 sText_VanishedInstantly[] =_("{JPN}{B_ATK_NAME_WITH_PREFIX}は しゅんじに すがたを けした!");
static const u8 sText_ProtectedTeam[] =_("{JPN}{B_CURRENT_MOVE}が {B_ATK_TEAM2}を まもった!");
...
static const u8 sText_HurledIntoTheAir[] =_("{JPN}{B_DEF_NAME_WITH_PREFIX}は そらへ ほうりだされた!");
static const u8 sText_HeldItemsLoseEffects[] =_("{JPN}もちものの こうかが なくなる\nふしぎな くうかんが できた!");
static const u8 sText_FellStraightDown[] =_("{JPN}{B_DEF_NAME_WITH_PREFIX}は まっすぐ おちてきた!");
static const u8 sText_TargetChangedType[] =_("{JPN}{B_DEF_NAME_WITH_PREFIX}は {B_BUFF1}タイプに なった!");
static const u8 sText_PkmnAcquiredSimple[] =_("{JPN}{B_DEF_NAME_WITH_PREFIX}は たんじゅんを てに いれた!");
static const u8 sText_KindOffer[] =_("{JPN}{B_DEF_NAME_WITH_PREFIX}は しんせつを うけとった!");
...
static const u8 sText_PostponeTargetMove[] =_("{JPN}{B_DEF_NAME_WITH_PREFIX}の わざは あとまわしに された!");
...
static const u8 sText_TrickRoomEnds[] = _("{JPN}ゆがんだ じくうが もとに もどった!");
...
static const u8 sText_ElectricTerrainEnds[] = _("{JPN}でんきが せんじょうから きえた。");
static const u8 sText_MistyTerrainEnds[] = _("{JPN}きりが せんじょうから きえた。");
static const u8 sText_PsychicTerrainEnds[] = _("{JPN}ふしぎな かんじが せんじょうから きえた。");
static const u8 sText_GrassyTerrainEnds[] = _("{JPN}くさが せんじょうから きえた。");
...
static const u8 sText_SlowStartEnd[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は ようやく やるきを だした!");
...
static const u8 sText_AnticipationActivates[] = _("{JPN}{B_SCR_ACTIVE_NAME_WITH_PREFIX}は みぶるいした!");
...
static const u8 sText_AttackerAquiredAbility[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_ATK_ABILITY}を てに いれた!");
...
static const u8 sText_PkmnBlewAwayToxicSpikes[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は どくびしを ふきとばした!");
static const u8 sText_PkmnBlewAwayStickyWeb[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は ねばねばネットを ふきとばした!");
static const u8 sText_PkmnBlewAwayStealthRock[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は ステルスロックを ふきとばした!");
...
static const u8 sText_IonDelugeOn[] = _("{JPN}イオンの あめが せんじょうに ふりそそぐ!");
static const u8 sText_TopsyTurvySwitchedStats[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}の のうりょくへんかが\nすべて ぎゃくに なった!");
static const u8 sText_TerrainBecomesMisty[] = _("{JPN}せんじょうに きりが たちこめた!");
static const u8 sText_TerrainBecomesGrassy[] = _("{JPN}せんじょうに くさが しげった!");
static const u8 sText_TerrainBecomesElectric[] = _("{JPN}せんじょうに でんきが ながれた!");
static const u8 sText_TerrainBecomesPsychic[] = _("{JPN}せんじょうが ふしぎな かんじに なった!");
static const u8 sText_TargetElectrified[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}の わざが でんきを おびた!");
...
static const u8 sText_HealBlockPreventsUsage[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は かいふくを ふうじられた!\p");
...
static const u8 sText_NoEffectOnTarget[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}には こうかが なかった!");
...
static const u8 sText_ThirdTypeAdded[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}に {B_BUFF1}タイプが くわわった!");
static const u8 sText_FellForFeint[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は フェイントに ひっかかった!");
static const u8 sText_PokemonCannotUseMove[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_CURRENT_MOVE}を つかえない!");
...
static const u8 sText_MistyTerrainPreventsStatus[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は まもりの きりに つつまれた!");
static const u8 sText_GrassyTerrainHeals[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は グラスフィールドで\nかいふくした!");
static const u8 sText_ElectricTerrainPreventsSleep[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は エレキフィールドに つつまれた!");
static const u8 sText_PsychicTerrainPreventsPriority[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は サイコフィールドに つつまれた!");
static const u8 sText_SafetyGogglesProtected[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は {B_LAST_ITEM}の おかげで\nえいきょうを うけない!");
static const u8 sText_FlowerVeilProtected[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は はなびらの ベールに つつまれた!");
static const u8 sText_SweetVeilProtected[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は あまい ベールに つつまれた!");
static const u8 sText_AromaVeilProtected[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は アロマベールに まもられている!");
...
static const u8 sText_LaserFocusMessage[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は しゅうちゅうしている!");
...
static const u8 sText_CloakedInAFreezingLight[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は こおりつく ひかりに つつまれた!");
...
static const u8 sText_AirLockActivates[] = _("{JPN}てんきの こうかが きえた。");
static const u8 sText_PressureActivates[] = _("{JPN}{B_SCR_ACTIVE_NAME_WITH_PREFIX}は プレッシャーを だしている!");
static const u8 sText_DarkAuraActivates[] = _("{JPN}{B_SCR_ACTIVE_NAME_WITH_PREFIX}は あくの オーラを はなっている!");
static const u8 sText_FairyAuraActivates[] = _("{JPN}{B_SCR_ACTIVE_NAME_WITH_PREFIX}は フェアリーの オーラを はなっている!");
...
static const u8 sText_ScreenCleanerActivates[] = _("{JPN}せんじょうの かべが すべて きえた!");
static const u8 sText_FetchedPokeBall[] = _("{JPN}{B_SCR_ACTIVE_NAME_WITH_PREFIX}は {B_LAST_ITEM}を みつけた!");
...
static const u8 sText_PkmnShookOffTheTaunt[] = _("{JPN}{B_SCR_ACTIVE_NAME_WITH_PREFIX}は ちょうはつから たちなおった!");
static const u8 sText_PkmnGotOverItsInfatuation[] = _("{JPN}{B_SCR_ACTIVE_NAME_WITH_PREFIX}の メロメロが なおった!");
static const u8 sText_ZPowerSurrounds[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は Zパワーに つつまれた!");
static const u8 sText_ZPowerUnleashed[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は ぜんりょくの Zワザを はなった!");
...
static const u8 sText_TerrainReturnedToNormal[] = _("{JPN}フィールドが もとに もどった!");
...
static const u8 sText_PkmnBurnHealed[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}の やけどが なおった。");
...
static const u8 sText_AttackerGotOverInfatuation[] =_("{JPN}{B_ATK_NAME_WITH_PREFIX}の メロメロが なおった!");
static const u8 sText_TormentedNoMore[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}の いちゃもんが とけた!");
static const u8 sText_HealBlockedNoMore[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}の かいふくふうじが とけた!");
...
static const u8 sText_ExtremelyHarshSunlight[] = _("{JPN}ひざしが とても つよく なった!");
...
static const u8 sText_NoReliefFromHeavyRain[] = _("{JPN}つよい あめは やみそうにない!");
static const u8 sText_MysteriousAirCurrent[] = _("{JPN}ふしぎな きりゅうが ひこうタイプの\nポケモンを まもっている!");
static const u8 sText_StrongWindsDissipated[] = _("{JPN}ふしぎな つよい かぜが やんだ!{PAUSE 64}");
...
static const u8 sText_PastelVeilEnters[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}の どくが なおった!");
static const u8 sText_BattlerTypeChangedTo[] = _("{JPN}{B_SCR_ACTIVE_NAME_WITH_PREFIX}の タイプが {B_BUFF1}に なった!");
...
static const u8 sText_PkmnBecameWeakerToFire[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は ほのおに よわく なった!");
...
static const u8 sText_NeutralizingGasOver[] = _("{JPN}かがくへんかガスの こうかが きれた!");
static const u8 sText_PkmnTookTargetHigh[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_DEF_NAME_WITH_PREFIX}を\nそらへ つれさった!");
static const u8 sText_TargetTooHeavy[] = _("{JPN}しかし あいてが おもすぎた!");
static const u8 sText_MeteorBeamCharging[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は うちゅうの エネルギーで\nあふれている!");
static const u8 sText_HeatingUpBeak[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は くちばしを あたためはじめた!");
static const u8 sText_CourtChange[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は りょうがわの こうかを\nいれかえた!");
static const u8 sText_AttackerExpelledThePoison[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は どくを はきだした!");
...
static const u8 sText_AttackerHealedItsBurn[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は きあいで やけどを なおした!");
static const u8 sText_AttackerHealedItsFrostbite[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は きあいで しもやけを なおした!");
...
static const u8 sText_AttackerLostElectricType[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は でんきを つかいきった!");
...
static const u8 sText_SharpSteelDmg[] = _("{JPN}とがった はがねが {B_DEF_NAME_WITH_PREFIX}に\nつきささった!");
static const u8 sText_PkmnBlewAwaySharpSteel[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は とがった はがねを ふきとばした!");
static const u8 sText_SharpSteelDisappearedFromTeam[] = _("{JPN}{B_ATK_TEAM2}の あしもとの\nとがった はがねが きえた!");
static const u8 sText_TeamTrappedWithVines[] = _("{JPN}{B_DEF_TEAM1}は つるに とらわれた!");
...
static const u8 sText_StockpiledEffectWoreOff[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}の たくわえるの こうかが きれた!");
...
static const u8 sText_ItemRestoredSpeciesHealth[] = _("{JPN}{B_BUFF1}の HPが かいふくした!");
static const u8 sText_ItemCuredSpeciesStatus[] = _("{JPN}{B_BUFF1}の じょうたいが なおった!");
static const u8 sText_ItemRestoredSpeciesPP[] = _("{JPN}{B_BUFF1}の PPが かいふくした!");
static const u8 sText_AtkTrappedDef[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は {B_DEF_NAME_WITH_PREFIX}を とらえた!");
...
static const u8 sText_TargetIsHurtBySaltCure[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は {B_BUFF1}の\nダメージを うけた!");
static const u8 sText_OpportunistCopied[] = _("{JPN}{B_SCR_ACTIVE_NAME_WITH_PREFIX}は あいての のうりょくへんかを\nコピーした!");
static const u8 sText_TargetCoveredInStickyCandySyrup[] = _("{JPN}{B_DEF_NAME_WITH_PREFIX}は ねばつく シロップに つつまれた!");
static const u8 sText_PkmnTellChillingReceptionJoke[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は さむい ジョークの\nじゅんびを している!");
static const u8 sText_ZeroToHeroTransformation[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は えいゆうの すがたに なった!");
...
static const u8 sText_TheRainbowDisappeared[] = _("{JPN}{B_ATK_TEAM2}がわの にじが きえた!");
...
static const u8 sText_TheSeaOfFireDisappeared[] = _("{JPN}{B_ATK_TEAM2}の ひのうみが きえた!");
static const u8 sText_SwampEnvelopedSide[] = _("{JPN}{B_DEF_TEAM2}は ぬまに つつまれた!");
static const u8 sText_TheSwampDisappeared[] = _("{JPN}{B_ATK_TEAM2}の ぬまが きえた!");
...
static const u8 sText_ElectroShotCharging[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は でんきを きゅうしゅうした!");
...
static const u8 sText_PkmnIncapableOfPower[] = _("{JPN}{B_ATK_NAME_WITH_PREFIX}は ちからを だせない ようだ!");
static const u8 sText_GlintAppearsInEye[] = _("{JPN}{B_SCR_ACTIVE_NAME_WITH_PREFIX}の めが ひかった!");
static const u8 sText_PkmnGettingIntoPosition[] = _("{JPN}{B_SCR_ACTIVE_NAME_WITH_PREFIX}は かまえを とった!");
